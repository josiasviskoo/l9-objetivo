...
function objetivo_cpt_definitions() {
	return array(
		'objetivo_banner'      => array(
			...
			'description' => __( 'Slides do banner rotativo no topo da home. A imagem destacada é o banner exibido no desktop; use o campo abaixo para a versão de celular (se não for definida, a imagem destacada é usada também no mobile). O título é só um rótulo interno, não aparece no site.', 'objetivo' ),
			'fields'      => array(
				array( 'key' => '_mobile_image', 'label' => __( 'Banner - Versão Mobile', 'objetivo' ), 'type' => 'image', 'help' => __( 'Opcional. Se vazio, a imagem destacada (desktop) é usada também em telas de celular.', 'objetivo' ) ),
			),
		),
